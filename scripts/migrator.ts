...
const DB_NAME = renv("DB_NAME", 'ccn')
const WORKER_NAME = renv("WORKER_NAME", 'ccn-server')
...
const githubClientId = env("CCN_GITHUB_CLIENT_ID")
const githubClientSecret = env("CCN_GITHUB_CLIENT_SECRET")
...
await putSecret('CCN_GITHUB_CLIENT_ID', githubClientId)
await putSecret('CCN_GITHUB_CLIENT_SECRET', githubClientSecret)
